...
# (OPTIONAL) cohort-based DQD settings ----------------------------------------------------------------
cohortDefinitionId <- c() # set to a cohort ID to restrict DQD to a specific cohort
cohortDatabaseSchema <- resultsDatabaseSchema # schema containing the cohort table
cohortTableName <- "cohort" # name of the cohort table
cohortFilterType <- "PersonOnly" # options: "PersonOnly", "PersonDate", "PersonDateTime"
# "PersonOnly" = filter by person_id only (default)
# "PersonDate" = filter by person_id AND date overlap with cohort period
# "PersonDateTime" = filter by person_id AND datetime overlap with cohort period
